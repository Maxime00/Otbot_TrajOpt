...
m.I_p = 2.2223; % Central moment of inertia of the platform body about axis 3" [kg*m^2]
m.I_a = 1.03570e-2; % Axial moment of inertia of one wheel [kg*m^2]
m.I_t = 5.61007e-3; % Twisting moment of inertia of one wheel [kg*m^2]

m.l_1 = 0.25; % Pivot offset relative to the wheels axis [m]
m.l_2 = 0.20; % One half of the wheels separation [m]

m.m_b = 105; % Mass of the chassis base [kg]
